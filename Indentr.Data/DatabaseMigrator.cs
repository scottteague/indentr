...
public class DatabaseMigrator(string connectionString)
{
    ...
    {
        yield return (1, ReadResource("Indentr.Data.Migrations.001_InitialSchema.sql"));
        yield return (2, ReadResource("Indentr.Data.Migrations.002_PrivacyAndPerUserRoot.sql"));
